...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)("easyglidesliderplugin/easyglideoneslide", {
  title: "Glide Slide",
  icon: "align-wide",
  supports: {
    align: ["full"]
...
function EditComponent(props) {
  ...
  const ALLOWED_BLOCKS = wp.blocks.getBlockTypes().map(block => block.name).filter(blockName => blockName !== "easyglidesliderplugin/easyglide-slider");
...
/******/ })()
;
//# sourceMappingURL=easyglideoneslide.js.map