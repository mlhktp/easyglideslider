...
class GlideJS {
  constructor() {
    ...
    allSlideshows.forEach(function (currentSlideshow) {
      ...
      const focusAtCentered = currentSlideshow.getAttribute(
        "data-focusAtCentered"
      );
      ...
      const swipeThreshold = currentSlideshow.getAttribute(
        "data-swipeThreshold"
      );
      ...
      const animationDuration = currentSlideshow.getAttribute(
        "data-animationDuration"
      );
      const rewind = currentSlideshow.getAttribute("data-rewind");
      const rewindDuration = currentSlideshow.getAttribute(
        "data-rewindDuration"
      );
      const animationTimingFunc = currentSlideshow.getAttribute(
        "data-animationTimingFunc"
      );
